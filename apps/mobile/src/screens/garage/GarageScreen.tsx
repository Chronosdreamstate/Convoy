...
const styles = StyleSheet.create({
  ...
  vehicleCardActive: { borderColor: '#FF6B00' },
  vehicleInfo: { flex: 1 },
  ...
  vehicleDetail: { fontSize: 13, color: '#888', marginTop: 4 },
  ...
  deleteButton: { backgroundColor: '#3A1515' },
  deleteButtonText: { color: '#FF4444', fontSize: 13, fontWeight: '600' },
  // Modal
  modalOverlay: {
    flex: 1,
  ...
  modalClose: { fontSize: 18, color: '#888', paddingHorizontal: 4 },
  formField: { marginBottom: 16 },
  formLabel: { fontSize: 13, color: '#AAA', marginBottom: 6 },
  formInput: {
    backgroundColor: '#1A1A1A',
    borderRadius: 12,
    borderWidth: 1,
